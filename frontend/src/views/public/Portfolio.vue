    ...
    return {
      projects: [
        ...
        },
        {
          ...
          technology: 'Laravel',
          description: 'API służy do zarządzania listą zadań w aplikacji typu "to-do". Umożliwia użytkownikom tworzenie, odczytywanie, edytowanie i usuwanie zadań (CRUD). API jest zgodne z zasadami REST i może być wykorzystywane w aplikacjach frontendowych lub mobilnych.',
          live: '#',
        ...
        },
        {
          ...
          technology: 'JavaScript, CSS3, HTML5',
          description: 'To prosta i funkcjonalna aplikacja webowa stworzona w HTML, CSS i JavaScript, której głównym celem jest umożliwienie użytkownikom tworzenia, zarządzania i śledzenia listy zadań do wykonania.',
        ...
        },
        {
          ...
          description: 'To system umożliwiający tworzenie i zarządzanie hierarchicznymi strukturami danych. Projekt opiera się na frameworku Laravel i wykorzystuje szablon Blade do generowania dynamicznych widoków. Głównym celem jest umożliwienie użytkownikom tworzenia, edytowania i zarządzania strukturami drzewiastymi, takimi jak kategorie, struktura menu, organizacje, lub inne złożone hierarchie danych.',
          live: '#',
